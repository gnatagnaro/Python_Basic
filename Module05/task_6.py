...
flat_price = int(input('Введите стоимость квартиры в млн. руб.: '))
flat_square = int(input('Введите площадь квартиры в кв. м: '))

if (flat_square >= 100 and flat_price <= 10) or (flat_square >= 80 and flat_price <= 7):
